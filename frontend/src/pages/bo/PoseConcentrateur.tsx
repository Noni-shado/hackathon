...
export function PoseConcentrateur() {
  ...
  const handlePose = async () => {
    ...
    try {
      const res = await boService.pose(numeroSerie.trim());
      setResult(res);
      setStep('success');
    } catch (err: any) {
      ...
      <div className={styles.container}>
        <header className={styles.header}>
          ...
          <div>
            ...
            <p>{boName} - Passer un concentrateur de "en stock" a "pose"</p>
          </div>
        </header>
            ...
            <div className={styles.cardBody}>
              <div className={styles.field}>
                ...
                <input
                  ...
                  onKeyDown={(e) => e.key === 'Enter' && handlePose()}
                  autoFocus
                />
              </div>
              ...
              <div className={styles.actions}>
                ...
                <Button variant="primary" onClick={handlePose} disabled={loading || !numeroSerie.trim()}>
                  {loading ? (
                    <>
